 ...
 *   - answers to a lang:text command, and translate the message in the required language
 *   - supports lang command listing the available languages for translation
...
var translate = require('./translateapi.js');

//
// Help command
//
controller.hears(['^help'], 'direct_message,direct_mention', function(bot, message) {
    bot.reply(message, "Hi, I am the Translate bot !\n\nType `lang:text` to see me in action.\n\nType `lang` to see possible list of languages available.");
});
...
controller.hears(['^lang'], 'direct_message,direct_mention', function(bot, message) {
    var email = message.user; // Spark User that created the message orginally 
    bot.reply(message, "Languages that can be passed for translation are: \n\n");
});
...
controller.hears(['^lang'], 'direct_message,direct_mention', function(bot, message) {
    var email = message.user; // Spark User that created the message orginally 
    //API call
    bot.reply(message, "Translated message from <@personEmail:" + email + "> \n\n");
});
